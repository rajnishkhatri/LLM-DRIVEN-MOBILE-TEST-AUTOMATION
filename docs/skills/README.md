...
| **aws-ai-\*** (6) | AWS AI/ML capability arm of arch-\* (Bedrock / SageMaker / agents; boto3 + CDK) | `.cursor/skills/aws-ai-*/` | Chat: `aws-ai-lifecycle`; **how-to:** [aws-ai-lifecycle-instructions.md](aws-ai-lifecycle-instructions.md); projected to `.claude/skills/` |
...
| [aws-ai-lifecycle-instructions.md](aws-ai-lifecycle-instructions.md) | Running aws-ai-\* **in this repo** — binding, five stages, per-axis gates, the offline-first credential gate |
