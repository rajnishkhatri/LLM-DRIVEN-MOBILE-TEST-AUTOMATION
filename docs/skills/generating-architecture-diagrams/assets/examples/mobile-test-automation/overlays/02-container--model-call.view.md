# Mobile Test Automation LLM Pipeline - Container view (logical components) — model-call overlay

![Mobile Test Automation LLM Pipeline - Container view (logical components) — model-call overlay](02-container--model-call.svg)
