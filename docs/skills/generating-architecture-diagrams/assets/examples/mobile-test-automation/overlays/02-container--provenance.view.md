# Mobile Test Automation LLM Pipeline - Container view (logical components) — provenance overlay

![Mobile Test Automation LLM Pipeline - Container view (logical components) — provenance overlay](02-container--provenance.svg)
