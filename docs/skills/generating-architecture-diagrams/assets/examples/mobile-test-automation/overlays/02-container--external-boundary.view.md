# Mobile Test Automation LLM Pipeline - Container view (logical components) — external-boundary overlay

![Mobile Test Automation LLM Pipeline - Container view (logical components) — external-boundary overlay](02-container--external-boundary.svg)
